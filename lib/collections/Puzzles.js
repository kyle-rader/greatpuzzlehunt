...
Meteor.methods({
    ...
    deletePuzzle(fields) {
        ...
        let imagesRemoved = Images.remove({_id: puzzle.hints });
        if (imagesRemoved !== puzzle.hints.length) throw new Meteor.Error(400, `Error: Wrong number of images were removed for puzzle ${puzzle._id}`);
