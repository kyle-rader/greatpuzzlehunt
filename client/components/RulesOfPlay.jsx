    ...
    return (
      <Container>
        ...
        <Responsive as={Segment} {...Responsive.onlyMobile} basic>
          ...
          <p>
            <Scrollchor to="#dont" animate={{ offset: -70, duration: 300 }}>
              <Button basic content="Dont" color="red"/>
            </Scrollchor>
          ...
          <List bulleted relaxed size="large">
            ...
            <List.Item>To solve a puzzle you must:
              <List ordered={true}>
                ...
                <List.Item>Select that puzzle from <Link to="/game">the game page</Link>.</List.Item>
            ...
            <List.Item><strong>Hint:</strong> Each puzzle results in a code word or words.</List.Item>
        ...
        <Segment basic>
          ...
          <List bulleted relaxed size="large">
            <List.Item>You are scored as a team in minutes. The fewer minutes the better.</List.Item>
            <List.Item>From puzzle timer start, you have 65 minutes to finish that puzzle. (15 for meta puzzle)</List.Item>
